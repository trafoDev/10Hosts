...
docker exec cli peer lifecycle chaincode approveformyorg \
            ...
            --channelID ${CHANNEL_ID} --name ${CC_NAME} --version ${VERSION_NB} --sequence ${SEQUENCE_NB} ${ENDORSEMENT_POLICY} --waitForEvent \
...
docker exec cli peer lifecycle chaincode checkcommitreadiness \
            --channelID ${CHANNEL_ID} --name ${CC_NAME} --version ${VERSION_NB} --sequence ${SEQUENCE_NB} ${ENDORSEMENT_POLICY}
