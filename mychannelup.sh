...
#CLI is on org1
docker exec cli peer channel create -o orderer1.hlftest.com:7050 -c mychannel -f ./channel-artifacts/channel.tx --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlftest.com/orderers/orderer1.hlftest.com/msp/tlscacerts/tlsca.hlftest.com-cert.pem
sleep 5
docker exec cli peer channel join -b mychannel.block

#docker exec -e CORE_PEER_ADDRESS=peer0.org1.hlftest.com:7051 \
#            -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.hlftest.com/peers/peer1.org1.hlftest.com/tls/ca.crt \
